...
function Mia() {
  return (
    <Container id="mia-container" className="align-middle">
      <Row id="mia-row">
        <Col>
          <p>
          &emsp;Halfway between the mustard brown station wagon and her first-floor
            apartment, Mia let loose a string of curses. Instead of sleeping in
            her own bed that night, she was to sleep in a stranger’s home to
            keep an ancient, 79lb monster of a German Shepherd company while his
            owner was away. Mia had forgotten about the dog named Fritz, and
            when her expletives ran dry, she sighed the kind of sigh that came
            from deep within – the kind that said <em>this well is empty</em>.
          </p>{" "}
          <p>
          ...
          <p>
          &emsp;Mia winced at the memory of the dog, all white flashes of teeth and
            distrust. She gathered her toothbrush, make-up bag, clothes to sleep
            in and a fresh uniform for the restaurant the following day.
          </p>{" "}
          <p>
          &emsp;She didn't mind dog-sitting at first. The extra money was all that
            kept the lights on, and aside from the travel and walks, the work
            was not very time consuming. Mia was mostly paid to sleep - to make
            anxious animals feel less alone in the hollow hours of the night,
            when darkness tugged on all assurances of safety.
          </p>{" "}
          <p>
